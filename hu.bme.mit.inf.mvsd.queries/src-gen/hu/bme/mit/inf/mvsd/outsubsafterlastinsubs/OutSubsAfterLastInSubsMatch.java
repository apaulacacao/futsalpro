...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.outSubsAfterLastInSubs pattern, 
 * to be used in conjunction with {@link OutSubsAfterLastInSubsMatcher}.
 * 
 ...
 * 
 */
public abstract class OutSubsAfterLastInSubsMatch extends BasePatternMatch {
  ...
  private OutSubsAfterLastInSubsMatch(final Object pPlayer, final Object pSubstitution) {
  ...
  public String[] parameterNames() {
    return OutSubsAfterLastInSubsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OutSubsAfterLastInSubsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    OutSubsAfterLastInSubsMatch other = (OutSubsAfterLastInSubsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return OutSubsAfterLastInSubsMatcher.factory().getPattern();
  ...
  static final class Mutable extends OutSubsAfterLastInSubsMatch {
  ...
  static final class Immutable extends OutSubsAfterLastInSubsMatch {
