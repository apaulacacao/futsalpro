...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.outSubs pattern, 
 * to be used in conjunction with {@link OutSubsMatcher}.
 * 
 ...
 * 
 */
public abstract class OutSubsMatch extends BasePatternMatch {
  ...
  private OutSubsMatch(final Object pPlayer, final Object pSubstitution) {
  ...
  public String[] parameterNames() {
    return OutSubsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OutSubsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    OutSubsMatch other = (OutSubsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return OutSubsMatcher.factory().getPattern();
  ...
  static final class Mutable extends OutSubsMatch {
  ...
  static final class Immutable extends OutSubsMatch {
