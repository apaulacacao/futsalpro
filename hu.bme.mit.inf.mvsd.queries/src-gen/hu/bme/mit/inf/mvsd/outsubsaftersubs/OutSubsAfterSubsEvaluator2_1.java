...
/**
 * A xbase xexpression evaluator tailored for the hu.bme.mit.inf.mvsd.outSubsAfterSubs pattern.
 */
public class OutSubsAfterSubsEvaluator2_1 implements IMatchChecker {
  /**
