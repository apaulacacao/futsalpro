...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamTimeoutsSecondHalf pattern, 
 * to be used in conjunction with {@link TeamTimeoutsSecondHalfMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamTimeoutsSecondHalfMatch extends BasePatternMatch {
  ...
  private TeamTimeoutsSecondHalfMatch(final Object pTeam, final Object pTimeout) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return TeamTimeoutsSecondHalfMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamTimeoutsSecondHalfMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamTimeoutsSecondHalfMatch other = (TeamTimeoutsSecondHalfMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamTimeoutsSecondHalfMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamTimeoutsSecondHalfMatch {
  ...
  static final class Immutable extends TeamTimeoutsSecondHalfMatch {
