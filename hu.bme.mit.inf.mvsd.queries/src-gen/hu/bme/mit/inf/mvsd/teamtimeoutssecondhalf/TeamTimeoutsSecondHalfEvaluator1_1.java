...
/**
 * A xbase xexpression evaluator tailored for the hu.bme.mit.inf.mvsd.TeamTimeoutsSecondHalf pattern.
 */
public class TeamTimeoutsSecondHalfEvaluator1_1 implements IMatchChecker {
  /**
   * The raw java code generated from the xbase xexpression by xtext.
   */
  private Boolean evaluateXExpressionGenerated(final Integer timestamp) {
    Integer _timestamp = timestamp;
    boolean _greaterEqualsThan = ((_timestamp).intValue() >= 1200);
