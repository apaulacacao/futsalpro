...
import hu.bme.mit.inf.mvsd.insubs.InSubsMatcherFactory;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.mvsd.inSubs pattern, 
 ...
 * 
 * @see InSubsMatch
 * @see InSubsMatcherFactory
 * @see InSubsProcessor
 * 
 */
public class InSubsMatcher extends BaseGeneratedMatcher<InSubsMatch> {
   ...
   * 
   */
  public InSubsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public InSubsMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a InSubsMatch object.
   * 
   */
  public Collection<InSubsMatch> getAllMatches(final Object pPlayer, final Object pSubstitution) {
   ...
   * @param pPlayer the fixed value of pattern parameter player, or null if not bound.
   * @param pSubstitution the fixed value of pattern parameter substitution, or null if not bound.
   * @return a match represented as a InSubsMatch object, or null if no match is found.
   * 
   */
  public InSubsMatch getOneArbitraryMatch(final Object pPlayer, final Object pSubstitution) {
   ...
   * 
   */
  public void forEachMatch(final Object pPlayer, final Object pSubstitution, final IMatchProcessor<? super InSubsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pPlayer, final Object pSubstitution, final IMatchProcessor<? super InSubsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<InSubsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pPlayer, final Object pSubstitution) {
   ...
   * 
   */
  public InSubsMatch newMatch(final Object pPlayer, final Object pSubstitution) {
    return new InSubsMatch.Immutable(pPlayer, pSubstitution);
   ...
   * 
   */
  public Set<Object> getAllValuesOfplayer(final InSubsMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfsubstitution(final InSubsMatch partialMatch) {
  ...
  @Override
  protected InSubsMatch tupleToMatch(final Tuple t) {
    try {
    	return new InSubsMatch.Immutable((java.lang.Object) t.get(POSITION_PLAYER), (java.lang.Object) t.get(POSITION_SUBSTITUTION));	
  ...
  @Override
  protected InSubsMatch arrayToMatch(final Object[] match) {
    try {
    	return new InSubsMatch.Immutable((java.lang.Object) match[POSITION_PLAYER], (java.lang.Object) match[POSITION_SUBSTITUTION]);
  ...
  @Override
  protected InSubsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new InSubsMatch.Mutable((java.lang.Object) match[POSITION_PLAYER], (java.lang.Object) match[POSITION_SUBSTITUTION]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IMatcherFactory<InSubsMatcher> factory() throws IncQueryException {
    return InSubsMatcherFactory.instance();
  }
}
