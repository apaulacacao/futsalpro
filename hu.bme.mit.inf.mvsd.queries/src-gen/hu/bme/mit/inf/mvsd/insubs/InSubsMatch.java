...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.inSubs pattern, 
 * to be used in conjunction with {@link InSubsMatcher}.
 * 
 ...
 * 
 */
public abstract class InSubsMatch extends BasePatternMatch {
  ...
  private InSubsMatch(final Object pPlayer, final Object pSubstitution) {
  ...
  public String[] parameterNames() {
    return InSubsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof InSubsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    InSubsMatch other = (InSubsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return InSubsMatcher.factory().getPattern();
  ...
  static final class Mutable extends InSubsMatch {
  ...
  static final class Immutable extends InSubsMatch {
