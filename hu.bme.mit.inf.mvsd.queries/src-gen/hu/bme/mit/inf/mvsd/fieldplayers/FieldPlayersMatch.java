...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.fieldPlayers pattern, 
 * to be used in conjunction with {@link FieldPlayersMatcher}.
 * 
 ...
 * 
 */
public abstract class FieldPlayersMatch extends BasePatternMatch {
  ...
  private FieldPlayersMatch(final Object pTeam, final Object pPlayer) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return FieldPlayersMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof FieldPlayersMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    FieldPlayersMatch other = (FieldPlayersMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return FieldPlayersMatcher.factory().getPattern();
  ...
  static final class Mutable extends FieldPlayersMatch {
  ...
  static final class Immutable extends FieldPlayersMatch {
