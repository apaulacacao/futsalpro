...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamGoalCountInitialTime pattern, 
 * to be used in conjunction with {@link TeamGoalCountInitialTimeMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamGoalCountInitialTimeMatch extends BasePatternMatch {
  ...
  private TeamGoalCountInitialTimeMatch(final Object pTeam, final Integer pGoalCount) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return TeamGoalCountInitialTimeMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamGoalCountInitialTimeMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamGoalCountInitialTimeMatch other = (TeamGoalCountInitialTimeMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamGoalCountInitialTimeMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamGoalCountInitialTimeMatch {
  ...
  static final class Immutable extends TeamGoalCountInitialTimeMatch {
