...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamGoals pattern, 
 * to be used in conjunction with {@link TeamGoalsMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamGoalsMatch extends BasePatternMatch {
  ...
  private TeamGoalsMatch(final Object pTeam, final Object pGoal) {
    this.fTeam = pTeam;
    this.fGoal = pGoal;
  ...
  public String[] parameterNames() {
    return TeamGoalsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamGoalsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamGoalsMatch other = (TeamGoalsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamGoalsMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamGoalsMatch {
  ...
  static final class Immutable extends TeamGoalsMatch {
