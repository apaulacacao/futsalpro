...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamGoalCountHalftime pattern, 
 * to be used in conjunction with {@link TeamGoalCountHalftimeMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamGoalCountHalftimeMatch extends BasePatternMatch {
  ...
  private TeamGoalCountHalftimeMatch(final Object pTeam, final Integer pGoalCount) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return TeamGoalCountHalftimeMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamGoalCountHalftimeMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamGoalCountHalftimeMatch other = (TeamGoalCountHalftimeMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamGoalCountHalftimeMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamGoalCountHalftimeMatch {
  ...
  static final class Immutable extends TeamGoalCountHalftimeMatch {
