...
import hu.bme.mit.inf.mvsd.lastoutsubs.LastOutSubsMatcherFactory;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.mvsd.lastOutSubs pattern, 
 ...
 * @see LastOutSubsMatcherFactory
 * @see LastOutSubsProcessor
 * 
 */
public class LastOutSubsMatcher extends BaseGeneratedMatcher<LastOutSubsMatch> {
   ...
   * 
   */
  public LastOutSubsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public LastOutSubsMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a LastOutSubsMatch object.
   * 
   */
  public Collection<LastOutSubsMatch> getAllMatches(final Object pPlayer, final Object pSubstitution) {
   ...
   * @param pPlayer the fixed value of pattern parameter player, or null if not bound.
   * @param pSubstitution the fixed value of pattern parameter substitution, or null if not bound.
   * @return a match represented as a LastOutSubsMatch object, or null if no match is found.
   * 
   */
  public LastOutSubsMatch getOneArbitraryMatch(final Object pPlayer, final Object pSubstitution) {
   ...
   * 
   */
  public void forEachMatch(final Object pPlayer, final Object pSubstitution, final IMatchProcessor<? super LastOutSubsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pPlayer, final Object pSubstitution, final IMatchProcessor<? super LastOutSubsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<LastOutSubsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pPlayer, final Object pSubstitution) {
   ...
   * 
   */
  public LastOutSubsMatch newMatch(final Object pPlayer, final Object pSubstitution) {
    return new LastOutSubsMatch.Immutable(pPlayer, pSubstitution);
   ...
   * 
   */
  public Set<Object> getAllValuesOfplayer(final LastOutSubsMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfsubstitution(final LastOutSubsMatch partialMatch) {
  ...
  @Override
  protected LastOutSubsMatch tupleToMatch(final Tuple t) {
    try {
    	return new LastOutSubsMatch.Immutable((java.lang.Object) t.get(POSITION_PLAYER), (java.lang.Object) t.get(POSITION_SUBSTITUTION));	
  ...
  @Override
  protected LastOutSubsMatch arrayToMatch(final Object[] match) {
    try {
    	return new LastOutSubsMatch.Immutable((java.lang.Object) match[POSITION_PLAYER], (java.lang.Object) match[POSITION_SUBSTITUTION]);
  ...
  @Override
  protected LastOutSubsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new LastOutSubsMatch.Mutable((java.lang.Object) match[POSITION_PLAYER], (java.lang.Object) match[POSITION_SUBSTITUTION]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IMatcherFactory<LastOutSubsMatcher> factory() throws IncQueryException {
    return LastOutSubsMatcherFactory.instance();
  }
}
