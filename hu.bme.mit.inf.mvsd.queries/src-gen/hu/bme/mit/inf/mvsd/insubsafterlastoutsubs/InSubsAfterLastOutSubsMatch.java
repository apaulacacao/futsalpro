...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.inSubsAfterLastOutSubs pattern, 
 * to be used in conjunction with {@link InSubsAfterLastOutSubsMatcher}.
 * 
 ...
 * 
 */
public abstract class InSubsAfterLastOutSubsMatch extends BasePatternMatch {
  ...
  private InSubsAfterLastOutSubsMatch(final Object pPlayer, final Object pSubstitution) {
  ...
  public String[] parameterNames() {
    return InSubsAfterLastOutSubsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof InSubsAfterLastOutSubsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    InSubsAfterLastOutSubsMatch other = (InSubsAfterLastOutSubsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return InSubsAfterLastOutSubsMatcher.factory().getPattern();
  ...
  static final class Mutable extends InSubsAfterLastOutSubsMatch {
  ...
  static final class Immutable extends InSubsAfterLastOutSubsMatch {
