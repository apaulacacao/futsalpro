...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.lastInSubs pattern, 
 * to be used in conjunction with {@link LastInSubsMatcher}.
 * 
 ...
 * 
 */
public abstract class LastInSubsMatch extends BasePatternMatch {
  ...
  private LastInSubsMatch(final Object pPlayer, final Object pSubstitution) {
  ...
  public String[] parameterNames() {
    return LastInSubsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof LastInSubsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    LastInSubsMatch other = (LastInSubsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return LastInSubsMatcher.factory().getPattern();
  ...
  static final class Mutable extends LastInSubsMatch {
  ...
  static final class Immutable extends LastInSubsMatch {
