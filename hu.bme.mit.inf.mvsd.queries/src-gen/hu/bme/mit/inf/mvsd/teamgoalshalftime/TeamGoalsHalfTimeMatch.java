...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamGoalsHalfTime pattern, 
 * to be used in conjunction with {@link TeamGoalsHalfTimeMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamGoalsHalfTimeMatch extends BasePatternMatch {
  ...
  private TeamGoalsHalfTimeMatch(final Object pTeam, final Object pGoal) {
    this.fTeam = pTeam;
    this.fGoal = pGoal;
  ...
  public String[] parameterNames() {
    return TeamGoalsHalfTimeMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamGoalsHalfTimeMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamGoalsHalfTimeMatch other = (TeamGoalsHalfTimeMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamGoalsHalfTimeMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamGoalsHalfTimeMatch {
  ...
  static final class Immutable extends TeamGoalsHalfTimeMatch {
