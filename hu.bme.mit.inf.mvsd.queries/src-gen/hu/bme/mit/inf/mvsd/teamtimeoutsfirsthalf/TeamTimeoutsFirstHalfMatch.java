...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamTimeoutsFirstHalf pattern, 
 * to be used in conjunction with {@link TeamTimeoutsFirstHalfMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamTimeoutsFirstHalfMatch extends BasePatternMatch {
  ...
  private TeamTimeoutsFirstHalfMatch(final Object pTeam, final Object pTimeout) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return TeamTimeoutsFirstHalfMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamTimeoutsFirstHalfMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamTimeoutsFirstHalfMatch other = (TeamTimeoutsFirstHalfMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamTimeoutsFirstHalfMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamTimeoutsFirstHalfMatch {
  ...
  static final class Immutable extends TeamTimeoutsFirstHalfMatch {
