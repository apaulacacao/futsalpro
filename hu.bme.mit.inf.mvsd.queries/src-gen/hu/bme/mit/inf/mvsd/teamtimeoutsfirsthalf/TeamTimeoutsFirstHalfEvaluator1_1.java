...
/**
 * A xbase xexpression evaluator tailored for the hu.bme.mit.inf.mvsd.TeamTimeoutsFirstHalf pattern.
 */
public class TeamTimeoutsFirstHalfEvaluator1_1 implements IMatchChecker {
  /**
