...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamFaultsFirstHalf pattern, 
 * to be used in conjunction with {@link TeamFaultsFirstHalfMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamFaultsFirstHalfMatch extends BasePatternMatch {
  ...
  private TeamFaultsFirstHalfMatch(final Object pTeam, final Object pFault) {
    this.fTeam = pTeam;
    this.fFault = pFault;
  ...
  public String[] parameterNames() {
    return TeamFaultsFirstHalfMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamFaultsFirstHalfMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamFaultsFirstHalfMatch other = (TeamFaultsFirstHalfMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamFaultsFirstHalfMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamFaultsFirstHalfMatch {
  ...
  static final class Immutable extends TeamFaultsFirstHalfMatch {
