...
/**
 * A xbase xexpression evaluator tailored for the hu.bme.mit.inf.mvsd.TeamFaultsFirstHalf pattern.
 */
public class TeamFaultsFirstHalfEvaluator1_1 implements IMatchChecker {
  /**
