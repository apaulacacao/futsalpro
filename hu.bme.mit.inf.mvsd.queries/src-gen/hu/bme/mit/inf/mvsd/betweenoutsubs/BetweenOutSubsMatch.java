...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.betweenOutSubs pattern, 
 * to be used in conjunction with {@link BetweenOutSubsMatcher}.
 * 
 ...
 * 
 */
public abstract class BetweenOutSubsMatch extends BasePatternMatch {
  ...
  private BetweenOutSubsMatch(final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter) {
  ...
  public String[] parameterNames() {
    return BetweenOutSubsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BetweenOutSubsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    BetweenOutSubsMatch other = (BetweenOutSubsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return BetweenOutSubsMatcher.factory().getPattern();
  ...
  static final class Mutable extends BetweenOutSubsMatch {
  ...
  static final class Immutable extends BetweenOutSubsMatch {
