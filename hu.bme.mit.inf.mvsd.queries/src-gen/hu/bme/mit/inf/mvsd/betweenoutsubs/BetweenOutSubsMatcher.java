...
import hu.bme.mit.inf.mvsd.betweenoutsubs.BetweenOutSubsMatcherFactory;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.mvsd.betweenOutSubs pattern, 
 ...
 * @see BetweenOutSubsMatcherFactory
 * @see BetweenOutSubsProcessor
 * 
 */
public class BetweenOutSubsMatcher extends BaseGeneratedMatcher<BetweenOutSubsMatch> {
   ...
   * 
   */
  public BetweenOutSubsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public BetweenOutSubsMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a BetweenOutSubsMatch object.
   * 
   */
  public Collection<BetweenOutSubsMatch> getAllMatches(final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter) {
   ...
   * @param pMid the fixed value of pattern parameter mid, or null if not bound.
   * @param pAfter the fixed value of pattern parameter after, or null if not bound.
   * @return a match represented as a BetweenOutSubsMatch object, or null if no match is found.
   * 
   */
  public BetweenOutSubsMatch getOneArbitraryMatch(final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter) {
   ...
   * 
   */
  public void forEachMatch(final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter, final IMatchProcessor<? super BetweenOutSubsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter, final IMatchProcessor<? super BetweenOutSubsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<BetweenOutSubsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter) {
   ...
   * 
   */
  public BetweenOutSubsMatch newMatch(final Object pPlayer, final Object pBefore, final Object pMid, final Object pAfter) {
    return new BetweenOutSubsMatch.Immutable(pPlayer, pBefore, pMid, pAfter);
   ...
   * 
   */
  public Set<Object> getAllValuesOfplayer(final BetweenOutSubsMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfbefore(final BetweenOutSubsMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfmid(final BetweenOutSubsMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfafter(final BetweenOutSubsMatch partialMatch) {
  ...
  @Override
  protected BetweenOutSubsMatch tupleToMatch(final Tuple t) {
    try {
    	return new BetweenOutSubsMatch.Immutable((java.lang.Object) t.get(POSITION_PLAYER), (java.lang.Object) t.get(POSITION_BEFORE), (java.lang.Object) t.get(POSITION_MID), (java.lang.Object) t.get(POSITION_AFTER));	
  ...
  @Override
  protected BetweenOutSubsMatch arrayToMatch(final Object[] match) {
    try {
    	return new BetweenOutSubsMatch.Immutable((java.lang.Object) match[POSITION_PLAYER], (java.lang.Object) match[POSITION_BEFORE], (java.lang.Object) match[POSITION_MID], (java.lang.Object) match[POSITION_AFTER]);
  ...
  @Override
  protected BetweenOutSubsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new BetweenOutSubsMatch.Mutable((java.lang.Object) match[POSITION_PLAYER], (java.lang.Object) match[POSITION_BEFORE], (java.lang.Object) match[POSITION_MID], (java.lang.Object) match[POSITION_AFTER]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IMatcherFactory<BetweenOutSubsMatcher> factory() throws IncQueryException {
    return BetweenOutSubsMatcherFactory.instance();
  }
}
