...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.mvsd.TeamFaults pattern, 
 * to be used in conjunction with {@link TeamFaultsMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamFaultsMatch extends BasePatternMatch {
  ...
  private TeamFaultsMatch(final Object pTeam, final Object pFault) {
    this.fTeam = pTeam;
    this.fFault = pFault;
  ...
  public String[] parameterNames() {
    return TeamFaultsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamFaultsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamFaultsMatch other = (TeamFaultsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamFaultsMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamFaultsMatch {
  ...
  static final class Immutable extends TeamFaultsMatch {
