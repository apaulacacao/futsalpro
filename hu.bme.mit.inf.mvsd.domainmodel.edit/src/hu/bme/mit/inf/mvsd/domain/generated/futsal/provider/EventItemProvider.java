...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.mvsd.domain.generated.futsal.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FutsalPackage.Literals.EVENT__TIME,
				 true,
				 false,
				 false,
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_previous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_previous_feature", "_UI_Event_type"),
				 FutsalPackage.Literals.EVENT__PREVIOUS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_next_feature", "_UI_Event_type"),
				 FutsalPackage.Literals.EVENT__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Event_type") + " " + event.getTime();
	}
