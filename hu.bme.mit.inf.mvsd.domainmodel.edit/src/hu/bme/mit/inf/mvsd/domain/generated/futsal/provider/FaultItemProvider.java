...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.mvsd.domain.generated.futsal.Fault} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FaultItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fault_player_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fault_player_feature", "_UI_Fault_type"),
				 FutsalPackage.Literals.FAULT__PLAYER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fault_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fault_type_feature", "_UI_Fault_type"),
				 FutsalPackage.Literals.FAULT__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Fault_type") + " " + fault.getTime();
	}
