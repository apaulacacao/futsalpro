 ...
 * <ul>
 *   <li>{@link hu.bme.mit.inf.mvsd.domain.generated.futsal.impl.TimeOutImpl#getTeam <em>Team</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimeOutImpl extends EventImpl implements TimeOut {
	/**
	...
	protected EClass eStaticClass() {
		return FutsalPackage.Literals.TIME_OUT;
	}
		...
		if (team != null && team.eIsProxy()) {
			...
			if (team != oldTeam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FutsalPackage.TIME_OUT__TEAM, oldTeam, team));
			}
		}
		return team;
	}
	...
	public void setTeam(Team newTeam) {
		...
		team = newTeam;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FutsalPackage.TIME_OUT__TEAM, oldTeam, team));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FutsalPackage.TIME_OUT__TEAM:
