...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>futsal</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FutsalExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FutsalPackage.eNS_URI, 
			 FutsalPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.futsal"));
				Match root = FutsalFactory.eINSTANCE.createMatch();
